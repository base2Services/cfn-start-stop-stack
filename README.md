...
--skip-wait
    ...
    Wating for resources to be completely stopped and sterted before continuing is ignored.

--wait-async

  Default wait action is to wait for each indiviual resource to be stopped and started before continuing.
  This will enabled waiting for resources in goups based on priority. Option only useful when used with
